...
import { Calendar, User, Clock, Search, Phone, Shield, CheckCircle, AlertTriangle } from 'lucide-react';
import { 
  getDoctorsApi, 
  getPatientInfoApi, 
  ...
  const loadCurrentUserInfo = async () => {
    ...
    try {
      ...
      if (error.message.includes('404')) {
        ...
        showError('Không tìm thấy thông tin bệnh nhân. Đang sử dụng dữ liệu tạm.');
      } else {
        showError(error.message || 'Không thể tải thông tin của bạn. Vui lòng thử lại sau.');
      }
    } finally {
      setLoading(false);
    }
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        <div style={{
          ...
          <div style={{
            ...
            {/* Left Column - Form */}
            <div style={{ padding: window.innerWidth >= 768 ? '3rem' : '2rem' }}>
              <h1 style={{
                fontSize: '1.875rem',
                fontWeight: 'bold',
                color: '#1f2937',
              ...
              <form onSubmit={handleSubmit}>
                ...
                {currentPatientInfo ? (
                  <div style={{
                    ...
                    <h3 style={{
                      ...
                      <User style={{ color: '#2563eb', marginRight: '0.5rem', width: '1.25rem', height: '1.25rem' }} />
                      Thông tin cá nhân
                    </h3>
                    <div style={{
                      display: 'grid',
                      ...
                      <div>
                        ...
                        <p style={{ fontWeight: '500', color: '#1f2937', margin: 0 }}>
                          {currentPatientInfo.fullName || currentPatientInfo.FullName || '-'}
                        </p>
                      </div>
                      <div>
                        <span style={{ color: '#4b5563' }}>Giới tính:</span>
                        <p style={{ fontWeight: '500', color: '#1f2937', margin: 0 }}>
                          {formatGender(currentPatientInfo.gender || currentPatientInfo.Gender)}
                        </p>
                      </div>
                      <div>
                        <span style={{ color: '#4b5563' }}>Ngày sinh:</span>
                        <p style={{ fontWeight: '500', color: '#1f2937', margin: 0 }}>
                          {(currentPatientInfo.birthdate || currentPatientInfo.Birthdate) ? formatDate(currentPatientInfo.birthdate || currentPatientInfo.Birthdate) : '-'}
                        </p>
                      </div>
                      <div>
                        <span style={{ color: '#4b5563' }}>Số điện thoại:</span>
                        <p style={{ fontWeight: '500', color: '#1f2937', margin: 0 }}>
                          {currentPatientInfo.phone || currentPatientInfo.Phone || '-'}
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div style={{
                    ...
                    <User style={{ color: '#6b7280', margin: '0 auto 0.5rem', width: '3rem', height: '3rem' }} />
                    <p style={{ color: '#6b7280' }}>Đang tải thông tin của bạn...</p>
                  </div>
                )}
                  ...
                  {selectedDoctor && (
                    <div style={{
                      ...
                      <div style={{ display: 'flex', alignItems: 'center' }}>
                        <User style={{ color: '#0891b2', fontSize: '1.5rem', marginRight: '0.75rem' }} />
                        <div>
                ...
                <div style={{ marginBottom: '2rem' }}>
                  ...
                  {schedules.length > 0 && (
                    <div style={{
                      ...
                      <CheckCircle style={{ color: '#10b981', marginRight: '0.25rem', width: '1rem', height: '1rem' }} />
                      Có <span style={{ fontWeight: '600' }}>{schedules.length}</span> lịch khám còn trống
                    </div>
                  )}
                  ...
                  <div style={{
                    ...
                    {!selectedDoctorId ? (
                      <div style={{
                        ...
                        <Calendar style={{ margin: '0 auto 0.5rem', width: '4rem', height: '4rem' }} />
                        ...
                        return (
                          <button
                            ...
                            style={{
                              ...
                              backgroundColor: isPast ? '#f3f4f6' : isSelected ? '#14b8a6' : '#f3f4f6',
                              color: isPast ? '#6b7280' : isSelected ? 'white' : '#374151',
                          ...
                          >
                            ...
                            <div style={{ fontSize: '0.75rem', marginTop: '0.25rem' }}>{time}</div>
                            <div style={{ fontSize: '0.75rem', color: isSelected ? 'rgba(255,255,255,0.8)' : '#6b7280' }}>
                  ...
                  <p style={{
                    ...
                    <AlertTriangle style={{ color: '#f59e0b', marginRight: '0.25rem', width: '1rem', height: '1rem' }} />
                    *Lưu ý: Bộ phận chăm sóc khách hàng sẽ liên hệ xác nhận lại thời gian với quý khách.
                  </p>
                </div>
                ...
                <div style={{ marginBottom: '2rem' }}>
                  <label style={{
                    ...
                    />
                    <div>
                      <span style={{ fontWeight: '500', color: '#374151' }}>Đặt hẹn ẩn danh</span>
                ...
                <div style={{ marginBottom: '2rem' }}>
                  <label style={{
                    ...
                    <span style={{ fontSize: '0.875rem', color: '#4b5563' }}>
                      Tôi đã đọc và đồng ý với các điều khoản sử dụng dịch vụ và cam kết thông tin cung cấp là chính xác. *
                    </span>
                  </label>
                </div>
                ...
                <button
                  ...
                  style={{
                    ...
                    padding: '1rem 2rem',
                    backgroundColor: loading || !currentPatientInfo ? '#9ca3af' : '#14b8a6',
                    color: 'white',
                    fontWeight: '600',
                    borderRadius: '9999px',
                    border: 'none',
                    cursor: loading || !currentPatientInfo ? 'not-allowed' : 'pointer',
            ...
            <div style={{
              ...
              <div style={{ position: 'relative' }}>
                ...
                <div style={{
                  ...
                  <CheckCircle style={{ color: 'white', width: '2rem', height: '2rem' }} />
                </div>
                ...
                <div style={{
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                    <Shield style={{ color: '#14b8a6', width: '1.25rem', height: '1.25rem' }} />
                    <span style={{ fontSize: '0.875rem', fontWeight: '500' }}>An toàn & Bảo mật</span>
                  </div>
                </div>
                ...
                <div style={{
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                    <Clock style={{ color: '#3b82f6', width: '1.25rem', height: '1.25rem' }} />
                    <span style={{ fontSize: '0.875rem', fontWeight: '500' }}>Đặt lịch 24/7</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <p style={{
              ...
              Chúng tôi đã nhận được yêu cầu đặt hẹn của bạn. Bộ phận chăm sóc khách hàng sẽ liên hệ xác nhận trong thời gian sớm nhất.
            </p>
            <button
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <AlertTriangle style={{ color: '#ef4444', width: '2.5rem', height: '2.5rem' }} />
            </div>
            <h3 style={{
              fontSize: '1.5rem',
              fontWeight: 'bold',
