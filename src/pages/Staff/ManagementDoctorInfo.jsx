...
export default function ManagementDoctorInfo() {
  ...
  const getAvailableDoctors = () => {
    ...
    return users.filter(u => u.role === "Doctor" && !existingDoctorIds.includes(u.userId));
  };
      ...
      <main className="content">
        ...
        <div className="table-container">
          <div className="table-header">
            ...
            <button className="btn-add-exam" onClick={openAddModal} disabled={loading}>
              ➕ Thêm Bác Sĩ Mới
            </button>
          </div>
          ...
          <table className="examination-table">
            ...
            <tbody>
              {loading ? (
                ...
                <tr><td colSpan="10" className="text-center">📝 Chưa có dữ liệu bác sĩ</td></tr>
              ) : (
                    ...
                    <tr key={doctor.doctorId}>
                      ...
                      <td>
                        <div className="doctor-avatar-cell">
                          <img 
                            src={doctor.doctorAvatar || userInfo.userAvatar || "/default-avatar.png"} 
                            alt="" 
                            className="doctor-avatar" 
                          />
                        </div>
                      </td>
                      <td><strong>{userInfo.fullName || doctor.doctorName || "N/A"}</strong></td>
                      ...
                      <td className="text-center">
                        {doctor.experienceYears ? 
                          <span className="experience-badge">{doctor.experienceYears} năm</span> 
                          : "N/A"
                        }
                      </td>
                      <td>
          ...
          <div className="modal-overlay">
            <div className="form-modal">
              <div className="form-header">
                <h2>
                  {editMode ? "✏️ Cập Nhật Thông Tin Bác Sĩ" : "🧑‍⚕️ Thêm Bác Sĩ Mới"}
                </h2>
                ...
                {!editMode && (
                  <div className="form-section">
                    ...
                    <div className="form-group">
                      <label>Bác sĩ <span style={{ color: "#ef4444" }}>*</span></label>
                      <select
                      ...
                      >
                        ...
                        {getAvailableDoctors().map((doctor) => (
                          <option key={doctor.userId} value={doctor.userId}>
                            {doctor.fullName} - {doctor.account?.email || doctor.email || ''}
                          </option>
                        ))}
                      </select>
                    </div>
                  ...
                  <div className="form-section">
                    ...
                    <div className="form-row">
                      <div className="form-group">
                        ...
                        <input 
                          type="text" 
                          value={getUserInfo(selectedDoctor?.doctorId).fullName || ""} 
                          disabled 
                        />
                      </div>
                      <div className="form-group">
                        ...
                        <input 
                          type="text" 
                          value={getUserInfo(selectedDoctor?.doctorId).account?.email || getUserInfo(selectedDoctor?.doctorId).email || ""} 
                          disabled 
                        />
                      </div>
                    </div>
