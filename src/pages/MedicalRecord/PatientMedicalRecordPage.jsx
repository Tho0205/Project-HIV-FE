        ...
        <section className="profile">
          ...
          <div className="card">
            ...
            >
              ...
              >
                💊 Lịch sử phác đồ ARV (
                {protocolHistory.filter((p) => p.baseProtocolId != null).length}
                )
              </button>
            </div>
              ...
              >
                ...
                >
                  {mainView === "examinations" ? (
                    <>
                      <option value="all">
                        Tất cả ({examinations.length})
                      </option>
                      <option value="completed">
                        Đã hoàn thành (
                        {
                          examinations.filter((e) => e.status === "ACTIVE")
                            .length
                        }
                        )
                      </option>
                    ...
                    <>
                      <option value="all">
                        Tất cả (
                        {
                          protocolHistory.filter(
                            (p) => p.baseProtocolId != null
                          ).length
                        }
                        )
                      </option>
                      <option value="active">
                        Đang áp dụng (
                        {
                          protocolHistory.filter(
                            (p) =>
                              p.status === "ACTIVE" && p.baseProtocolId != null
                          ).length
                        }
                        )
                      </option>
